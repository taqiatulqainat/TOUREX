...
//         <h2>
//           Delicious Dining, <br /> Delivered to You.
//         </h2>
//         <p>
...
//         </p>
//         <button className="dining-btn">Find Your Meal</button>
//       </div>

//       {/* Right side images */}
//       <div className="dining-images">
//         {/* First image */}
//         <div className="dining-img dining-img1">
//           <img src={Biryani} alt="Dish 1" />
//           <span className="dining-badge">1/1</span>
//           <p className="dining-caption">Here’s a dump of all the food that made my taste buds dance.</p>
//         </div>

//         {/* Second image */}
//         <div className="dining-img dining-img2">
//           <img src={Pasta} alt="Dish 2" />
//           <span className="dining-badge">1/2</span>
//           <p className="dining-caption">Too pretty to eat… but I did.</p>
//         </div>

//         {/* Third image */}
//         <div className="dining-img dining-img3">
//           <img src={Beef} alt="Dish 3" />
//           <span className="dining-badge">1/3</span>
//           <p className="dining-caption">One bite closer to happiness!</p>
//         </div>
//       </div>
//     </div>
//   );
